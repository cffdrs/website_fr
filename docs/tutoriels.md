<a href="https://cffdrs.github.io/website_en/tutorials/" target="_self" style="float: right;"> English </a>
...
<div class="text-center">
	<button class="btn btn-dark" onclick="location.href='../tutoriels/IFM_horaire_C'">HOURLY FWI <br> Tutorial <br> C</button>
	&emsp;
    <button class="btn btn-dark" onclick="location.href='../tutoriels/IFM_horaire_Python'">HOURLY FWI <br> Tutorial <br> Python</button>
	&emsp;
	<button class="btn btn-dark" onclick="location.href='../tutoriels/IFM_horaire_R'">HOURLY FWI <br> Tutorial <br> R</button>
</div>
<br>
