...
Les [scripts NG-CFFDRS](https://github.com/nrcan-cfs-fire/cffdrs-ng) (en anglais) sont sous licence [Mozilla Public License 2.0](https://mozilla.org/MPL/2.0/). Une copie de la licence est disponible sur le [référentiel GitHub](https://github.com/nrcan-cfs-fire/cffdrs-ng/blob/main/LICENSE.txt) (en anglais).
